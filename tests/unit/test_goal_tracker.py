...
class TestParseSorryResult:
    ...
    def test_malformed_json_summary(self):
        ...
        diags = [
            {"severity": 3, "message": 'MCP_NODE:{"name":"A","explicit":true,"sorry_deps":[]}'},
    ...
    def test_duplicate_node_overwrites(self):
        ...
        diags = [
            {"severity": 3, "message": 'MCP_NODE:{"name":"A","explicit":false,"sorry_deps":["X"]}'},
            {"severity": 3, "message": 'MCP_NODE:{"name":"A","explicit":true,"sorry_deps":["Y"]}'},
        ]
        nodes, _ = parse_sorry_result(diags)
    ...
    def test_ignores_warning_severity(self):
        ...
        diags = [
            {"severity": 2, "message": 'MCP_NODE:{"name":"X","explicit":true,"sorry_deps":[]}'},
        ]
        nodes, _ = parse_sorry_result(diags)
        assert nodes == {}
    ...
    def test_mixed_errors_warnings_infos(self):
        ...
        diags = [
            {"severity": 1, "message": 'MCP_NODE:{"name":"err","explicit":true,"sorry_deps":[]}'},
            {"severity": 2, "message": 'MCP_NODE:{"name":"warn","explicit":true,"sorry_deps":[]}'},
            {"severity": 3, "message": 'MCP_NODE:{"name":"info","explicit":true,"sorry_deps":[]}'},
